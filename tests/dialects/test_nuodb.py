...
class TestNuoDB(Validator):
    ...
    def test_ddl(self):
        ...
        self.validate_all(
            ...
            write={"nuodb": "CREATE SCHEMA simpleDB",}
        )
    ...
    def test_lock_table(self):
        self.validate_identity("LOCK TABLE `datatypes1` EXCLUSIVE", write_sql="nuodb")
    ...
    def test__auto_increment_to_generated_by_default(self):
        self.validate_all(
            ...
            write={"nuodb" : "CREATE TABLE employees (id INT GENERATED BY DEFAULT AS IDENTITY, first_name VARCHAR(50), last_name VARCHAR(50), salary DECIMAL(10, 2))"}
        )
